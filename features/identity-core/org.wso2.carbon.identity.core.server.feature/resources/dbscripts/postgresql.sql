...
DROP TABLE IF EXISTS OAUTH_APP_METADATA;
DROP SEQUENCE IF EXISTS OAUTH_APP_METADATA_PK_SEQ;
CREATE SEQUENCE OAUTH_APP_METADATA_PK_SEQ;
CREATE TABLE OAUTH_APP_METADATA (
            ID INTEGER DEFAULT NEXTVAL('OAUTH_APP_METADATA_PK_SEQ'),
            APP_ID INTEGER,
            META_DATA VARCHAR(500),
            CONSTRAINT OAUTH_METADATA_CONSTRAINT UNIQUE (APP_ID),
            PRIMARY KEY (ID),
